...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('personal_access_tokens', static function (Blueprint $Blueprint) {
            ...
            $Blueprint->char('tokenable_id', 26)->comment('The identifier of the user the token belongs to');
            ...
            $Blueprint->foreign('tokenable_id')->references('id')->on('users')->cascadeOnDelete();
        });
    }
