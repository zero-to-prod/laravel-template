...
enum ModelHasRoles: string
{
    use HasColumn;

    #[Column([
        Column::name => self::role_id,
        Column::comment => 'The role that is granted',
    ...
    #[Column([
        ...
        Column::comment => 'The class of the model the role is granted to',
    ...
    #[Column([
        ...
        Column::comment => 'The identifier of the model the role is granted to',
        Column::type => ColumnType::char->value,
        Column::length => 26,
        Column::nullable => false,
        Column::primary_key => true,
