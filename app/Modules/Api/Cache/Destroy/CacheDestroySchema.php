 ...
 */
readonly class CacheDestroySchema implements DescribesOperation
{
        ...
        return [
            ...
            'paths' => [
                ApiRoute::cache_key->value => [
                    'delete' => [
                        'operationId' => 'destroyCacheEntry',
                        'summary' => 'Delete one cache entry.',
                        'tags' => ['Cache'],
                        'security' => [[SharedSchema::bearer => []]],
                        'parameters' => [KeyParameter::schema()],
                        'responses' => [
                            '200' => [
                                'description' => 'The cache entry was deleted.',
                                'content' => [
                                    'application/json' => ['schema' => CacheDestroyResponse::schema()],
                                ],
                            ],
                            '401' => [
