 ...
 */
readonly class AdminLogHostIndexSchema implements DescribesOperation
{
    ...
    public static function schema(): array
    {
        return [
            ...
            'paths' => [
                Admin::api_logs_hosts->value => [
                    'get' => [
                        'operationId' => 'listLogHosts',
                        'summary' => 'List configured log hosts.',
                        'tags' => ['Logs'],
                        'responses' => [
                            '200' => [
                                'description' => 'The successful response.',
                                'content' => [
                                    'application/json' => ['schema' => AdminLogHostIndexResponse::schema()],
                                ],
                            ],
                            '401' => [
