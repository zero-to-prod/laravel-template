 ...
 */
readonly class AdminLogFileDownloadRequestSchema implements DescribesOperation
{
    ...
    public static function schema(): array
    {
        return [
            ...
            'paths' => [
                Admin::api_logs_file_download_request->value => [
                    'get' => [
                        'operationId' => 'requestLogFileDownload',
                        'summary' => 'Request a temporary log file download URL.',
                        'tags' => ['Logs'],
                        ...
                        'responses' => [
                            '200' => [
                                ...
                                'content' => [
                                    'application/json' => ['schema' => AdminLogFileDownloadRequestResponse::schema()],
                                ],
                            ],
                            '404' => [
