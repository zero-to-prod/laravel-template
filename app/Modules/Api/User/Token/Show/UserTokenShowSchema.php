 ...
 */
readonly class UserTokenShowSchema implements DescribesOperation
{
    /**
        ...
        return [
            ...
            'paths' => [
                ApiRoute::user_token->value => [
                    'get' => [
                        'operationId' => 'showUserToken',
                        'summary' => 'Retrieve one personal access token of the authenticated user.',
                        'tags' => ['Tokens'],
                        ...
                        'responses' => [
                            '200' => [
                                ...
                                'content' => [
                                    'application/json' => ['schema' => UserTokenShowResponse::schema()],
                                ],
                            ],
                            '401' => [
